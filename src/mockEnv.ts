      ...
      launchParams: new URLSearchParams([
        ...
        ['tgWebAppData', new URLSearchParams([
          ...
          ['user', JSON.stringify({
                        ...
                        photo_url: import.meta.env.MOCK_PHOTO_URL || 'https://t.me/i/userpic/320/it5N-6kWcwjFkjS2ju7doeoXxu5MTcD-OjMf614ZB6O_kE_ycZm8Omc4lfLgqHE6.svg',
                         })],
        ]).toString()],
        ['tgWebAppVersion', '8.4'],
        ['tgWebAppPlatform', 'tdesktop'],
        ['tgWebAppStartParam', 'co_z9nJQ6bJUN3tV8DvHuQZiyHJdAN'],
      ]),
    });
